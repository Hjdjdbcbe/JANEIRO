...
-- المصدر: supabase/migrations/001_core_schema.sql + supabase/migrations/021_gift_card_bot.sql supabase/migrations/022_bot_sales_detail.sql supabase/migrations/023_bot_certificates.sql
--
