...
cat <<'EOF'
  ...
  وإن نشرت بوت المخزون: للتأكّد أن كل شيء سليم قبل أي شيء آخر:

        bash tools/check-bot.sh

     يفحص التوكن والدالة والـwebhook والسرّ، ويقول أين الخلل بالضبط
     إن وُجد. ثم افتحه في تليجرام وأرسل /start — تُفتح لك
