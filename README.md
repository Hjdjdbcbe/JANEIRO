...
| `ui.test.js` | بلاطة الأيقونة في مواضعها الثلاثة، صورة مرفوعة كسولة بأبعاد ثابتة، الرجوع للأيقونة المصممة عند الفشل، قسم العروض والعدّاد الحيّ، وصول سعر العرض للسلة، إخفاء القسم بلا عروض، حدود الحركة، و`prefers-reduced-motion`، وغياب التمرير الأفقي عند 375/390/430px |
