...
`023_bot_certificates.sql` (وثيقة ضمان لكل بيعة: بيانات الزبون
تُسأل بعد التأكيد، وتاريخا البداية والنهاية محسوبان من المدة،
وبحث عن الزبون واشتراكات تنتهي قريباً) +
`024_bot_customer_form.sql` (رابط يعبّي فيه الزبون بياناته بنفسه،
ووثيقة يحفظها أو يطبعها PDF وتحتها قنوات تواصلك، و«من ينتهي
اشتراكه اليوم»).
